...
- ALWAYS use a standard hyphen "-" for bullet points. Do not use asterisks or dots.
- Be concise and professional. Do not add unnecessary conversational filler.
"""
...
"""
                ...
                # Optional: Token usage display so you can monitor costs
                if hasattr(response, 'usage_metadata'):
                    st.caption(f"🛡️ **Cost Guard:** Used {response.usage_metadata.total_token_count} total tokens.")
